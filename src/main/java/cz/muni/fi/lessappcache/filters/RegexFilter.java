 ...
 * called as {@literal @}regex path pattern
 *
 * @author Petr Kunc
 */
public class RegexFilter extends AbstractWalkDir implements Filter {

    private final static Logger logger = Logger.getLogger(RegexFilter.class.getName());

    /**
     * Executor of filter, walks given directory and finds all files matching given regex pattern
     *
     * @param args must contain three arguments, (0 - name of filter), 1 - path to directory to be walked, 2 - regex pattern
